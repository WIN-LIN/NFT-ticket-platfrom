...
const { createEvent, getEvents, sellTickets, mintTickets, getTickets, buyTicket } = require('../controllers/adminController');
...
router.route('/buyTicket').post( wrapAsync(buyTicket));
